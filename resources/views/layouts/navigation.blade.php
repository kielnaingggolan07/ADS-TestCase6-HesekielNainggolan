...
<head>
    ...
    <link href="{{ asset('css/bootstrap.min.css') }}" rel="stylesheet">
         ...
         <style>
            ...
            .dropdown-menu {
                width: 100px; /* Lebar menu drop-down secara umum */
            }

            .dropdown-item {
                width: 100px; /* Atur lebar tombol sesuai kebutuhan Anda */
                white-space: nowrap;
            }
        </style>
         <!-- Scripts -->
...
<body style="">
    <header>
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #C6E4F9">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-login" aria-labelledby="navbarDropdown" style="min-width: 0; padding: 0;">
                              @if (Auth::check())
